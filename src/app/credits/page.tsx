...
export const metadata: Metadata = {
  ...
  description:
    "Attribution for the third-party 3D models used in the interactive scene on the home page.",
};
...
// Every external 3D asset used by the Hero scene. Keep in sync with
// public/models/CREDITS.md.
const assets = [
  {
    title: "male_base",
    role: "Human head and shoulders bust — Human–Machine Interaction node",
    creator: "hedy magroun",
    sourceUrl: "https://poly.pizza/m/eqJEiOX0Fhl",
    changes:
      "Removed the eyeball mesh, stripped materials and textures, welded and compressed the mesh, and restyled it as dark glass with an EEG-style mesh overlay.",
  },
  {
    title: "Brain",
    role: "Anatomical brain — AI / ML node hologram",
    creator: "J-Toastie",
    sourceUrl: "https://poly.pizza/m/YihDCHsOPO",
    changes:
      "Stripped materials, recomputed smooth normals, compressed the mesh, and restyled it as a blue hologram with a wireframe overlay.",
  },
];
  ...
  return (
    <>
      <PageHeader
        eyebrow="Credits"
        title="3D Asset Credits"
        subtitle="Two third-party models appear in the interactive scene on the home page. Everything else in the scene is original, procedurally generated geometry."
      />
