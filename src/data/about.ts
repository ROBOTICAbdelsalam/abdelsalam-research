...
// unrelated skills, but the order these were actually acquired and applied.
...
export const researchInterests: string[] = [
  "Adaptive, learning-driven Brain-Computer Interfaces",
  "AI-driven industrial and collaborative robotics",
  "Human-robot interaction and shared control",
  "Autonomous mobile robots and intelligent perception",
];

export const engineeringInterests: string[] = [
  "Industrial automation and control (PLC, SCADA, IIoT)",
  "AI-integrated robotic systems for manufacturing and logistics",
  "AI agents and workflow automation",
  "Adaptive, data-driven decision systems",
];

export const currentProjects: string[] = [
  "Hybrid Adaptive BCI — M.Sc. thesis decoding EEG to control industrial and medical robots (JAMK, completed 2026)",
  "Exploring AI agents and automation workflows as an emerging engineering direction",
];

export const futureDirection: string =
  "Finishing the M.Sc. and building on the Hybrid Adaptive BCI thesis, while growing into AI agents, automation and data-driven systems as a complement to an established robotics and industrial automation background.";

export const languages: { name: string; level: string }[] = [
  { name: "Arabic", level: "Native" },
  { name: "English", level: "C2 — Proficient" },
  { name: "Finnish", level: "B2 — Upper Intermediate" },
];
