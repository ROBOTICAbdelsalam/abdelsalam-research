...
export function EventCard({ event, delay = 0 }: { event: EventItem; delay?: number }) {
  return (
    <Reveal delay={delay} className="h-full">
      <div className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-border bg-surface transition-all duration-300 hover:border-accent/40 hover:-translate-y-0.5">
        {event.image ? (
